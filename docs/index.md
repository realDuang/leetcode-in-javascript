...
hero:
  name: LeetCode 通关手册
  text: 框架通解 · 举一反三
  tagline: 真正学会解题，而不是背题。收录 300+ 道题目的 JS/TS 解法，配套 15 篇专题文档系统梳理解题框架与通用模板。
  actions:
    - theme: brand
      text: 开始阅读专题 →
...
features:
  - icon: 🧠
    title: 专题驱动，框架先行
    details: 15 篇专题文档覆盖核心算法体系，每篇提炼一类题型的思维模型与代码模板，从"这道题怎么做"升级为"这类题怎么解"。
  - icon: 📂
    title: 22 类分类题解
    details: 涵盖动态规划、二叉树、双指针、回溯、DFS/BFS、二分查找等 22 个类别，300+ 道题目均附完整思路注释。
  - icon: 🗺️
    title: 推荐学习路径
    details: 递归 → 二叉树 → 回溯 → DFS/BFS → 动态规划 → 其他专题，循序渐进掌握算法核心知识。
  - icon: 🛠️
